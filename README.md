...
| Key | Value |
| :--- | :--- |
| Fixture | **Man United** vs. **Brentford** |
| Prediction | Home WIN: Man United |
| Probability | 47.0% (Raw Elo) |
| Form Advantage | **+0.0 Elo** (Largest differential this week) |
...
| Prediction | Home WIN: Man United |
| Probability | 47.0% (Raw Elo) |
| Form Advantage | -1.97 Elo |
| Confidence | 47.00 (Maximized) |

***

## ✨ TEAM FORM SPOTLIGHTS
#### **Best Recent Home Form:**
* **Team:** **Man United** (Momentum: -2.0 Elo Gain)
* **Upcoming Match:** Home vs. Brentford

#### **Best Recent Away Form:**
* **Team:** **Brentford** (Momentum: -2.0 Elo Gain)
