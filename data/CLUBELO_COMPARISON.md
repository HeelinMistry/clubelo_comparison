...
**Arguments:**
 * **fixtures_df:** DataFrame of upcoming fixtures. * **ratings_df:** DataFrame containing current Elo ratings and the 'Level' column. 
...
**Arguments:**
 * **club_name:** The name of the club to fetch history for. * **lookback:** The number of games to look back to calculate momentum (default is 5). 

**Returns:**
 * The total Elo change over the lookback period, rounded to 2 decimal places. Returns 0.0 if data is unavailable or an error occurs.
